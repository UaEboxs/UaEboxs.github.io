...
`,
    ...
    const Gp = class {
        ...
        static sanitizeName(t) {
            return t.replace(/[^A-Z0-9\u00A1\u0020-\u002F\u00BF-\АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЬьЮюЯя\u00FF\u2026!?*$+\-'_ .,]/gi, "").replace(/'/g, "\u2019")
        }
        static sanitizeInput(t) {
            return t.replace(/[^\u00A1\u0020-\u007E\АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЬьЮюЯя\u00BF-\u00FF’]/gi, "")
        }
...
${t}`
    ...
    const lee = {
        ...
        fee = {
            NAME: "ІМ'Я",
            NAME_PLACEHOLDER: "ВВЕДИ СВОЄ ІМ'Я",
            PASSWORD_PLACEHOLDER: "П'ЯТИЗНАЧНИЙ ПАРОЛЬ",
            PASSWORD_REQUIRED_TITLE: "Потрібен пароль",
        ...
        hee = {
            ...
            LOGOUT: "ВИЙТИ",
            MERCH: "MERCH",
            PAST_GAMES: "МИНУЛІ ІГРИ",
            MAILING_LIST: "MAILING LIST",
            MODERATOR: "МОДЕРАТОР"
        },
        pee = {
            CALL_TO_ACTION: {
                SHOP: "ПОДИВИТИСЯ І ЗАЙТИ В МАГАЗИН",
                VIEW: "ПОДИВИТИСЯ ЦЮ ГРУ"
            },
            NEW: "НОВИНКА",
            PLAYED_ON: "СИГРАНО В",
            REMOVE: {
...
from your past games list.`,
        ...
        mee = {
            TITLE: "МИНУЛІ ІГРИ",
            VIEW_ALL: {
                BUTTON: "ПОСМОТРИТИ ВСЕ",
                LINK: "ПОДИВИТИСЯ ВСІ ІГРИ"
            }
        },
        vee = {
        ...
        _ee = {
            ...
            JOIN_AUDIENCE: "ЗАЙТИ ДО ГЛЯДАЧІВ",
            RECONNECT: "ПЕРЕЗАЙТИ",
            TWITCH_LOGIN: "ЗАЙТИ ВИКОРИСТОВУЮЧИ ТВІЧ"
        },
        yee = {
            ...
            TOS: "Натискаючи {submit}, ви погоджуєтеся з [tos]Умовами користування[/tos]"
        },
        Eee = {
            BRANCH: lee,
            ERROR: uee,
